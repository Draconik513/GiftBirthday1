...
export default function LoveCalendar() {
  ...
  const favoritePhotos = [
    { month: "January", image: januaryImg, description: "Waktu kita nonton film bareng untuk pertama kali." },
    { month: "February", image: februaryImg, description: "Momen romantis pas Valentine kita." },
    { month: "March", image: marchImg, description: "Kita jalan-jalan ke pantai bareng!" },
    { month: "April", image: aprilImg, description: "Ngopi bareng sambil ngobrol panjang lebar." },
    { month: "May", image: mayImg, description: "Foto waktu ulang tahun kamu ❤️" },
    { month: "June", image: juneImg, description: "Sunset bareng di atas bukit 🌅" },
    { month: "July", image: julyImg, description: "Main hujan-hujanan bareng ☔" },
    { month: "August", image: augustImg, description: "Waktu kita ikut lomba 17an bareng 😄" },
    { month: "September", image: septemberImg, description: "Foto waktu kita belajar bareng di taman." },
    { month: "October", image: octoberImg, description: "Pas Halloween dan kamu lucu banget kostumnya!" },
    { month: "November", image: novemberImg, description: "Waktu piknik di bawah pohon rindang 🍂" },
    { month: "December", image: decemberImg, description: "Natal pertama kita bareng 🎄" }
  ];
